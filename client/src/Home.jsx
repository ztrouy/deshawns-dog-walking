...
export default function Home() {
  ...
  return (
    <div className="w-75 mx-auto">
      ...
      {dogs.map(dog => <DogCard dog={dog} showRemove={true} isNameClickable={true} key={dog.id} fetchDogs={fetchDogs} setChosenDog={setChosenDog} toggleModal={toggleDetailsModal} />)}
